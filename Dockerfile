...
RUN wget https://github.com/ycashfoundation/ycash/releases/download/2.0.5.5/linux-binaries-ycash-v2.0.5.5.tar.gz -O - | tar --strip-components 1 -C /opt/coin -xzf -
